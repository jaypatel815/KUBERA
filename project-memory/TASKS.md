...
- [x] T097 v2 — Sculpted 3D face (owner: v1 too pixelated): continuous gaussian-
  feature depth field tuned via offline renders, ~12k WebGL points (three.js CDN,
  additive), shader-driven cursor-follow / pupil-lead / lip-sync / shimmer /
  edge-dissolve, 3/4 rest pose per reference, CDN-fail fallback pulse — 2026-08-14.
